...
| 4 | Migrate async layer from RxJava 3 → Coroutines incrementally via `kotlinx-coroutines-rx3` | Known | [`README.md`](../../../README.md), [`.github/skills/migration/rxjava-to-coroutines-migration/SKILL.md`](../../../.github/skills/migration/rxjava-to-coroutines-migration/SKILL.md) |
...
| 10 | Adopt agent skills under `.github/skills/` per [GitHub's Agent Skills spec](https://docs.github.com/en/copilot/concepts/agents/about-agent-skills) | Known | This skill at [`.github/skills/curated/repo-knowledge-base/SKILL.md`](../../../.github/skills/curated/repo-knowledge-base/SKILL.md) and 40+ others under `.github/skills/` |

Use the template in [`.github/skills/curated/repo-knowledge-base/SKILL.md`](../../../.github/skills/curated/repo-knowledge-base/SKILL.md) §"Eleventh Pass: Decisions and History" if you formalize any of these as standalone ADRs.
