...
/**
 * Hosts [CreditsScreen] — the in-app "Credits & Thanks" page that prominently
 * acknowledges the original TransTracks team and surfaces the GPL-3.0-or-later
 * license. Reachable from Settings → About → "Credits & Thanks".
 */
    ...
    private fun openUrl(url: String) {
        ...
        if (intent.resolveActivity(activity.packageManager) != null) {
            try {
                ...
                // No browser available; silently ignore — user can copy URL.
            }
        }
    }
}
