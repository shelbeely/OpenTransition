...
import com.shelbeely.opentransition.domain.SettingsResult.Content
import com.shelbeely.opentransition.domain.SettingsResult.Loading
import com.shelbeely.opentransition.domain.SettingsViewEffect.ShowBackupResult
import com.shelbeely.opentransition.ui.settings.SettingsUIUserDetails
import com.shelbeely.opentransition.util.FileUtil
import com.shelbeely.opentransition.util.RxSchedulers
import com.shelbeely.opentransition.util.hasPasswordProvider
...
import com.shelbeely.opentransition.util.writeFile
            ...
            return ObservableTransformer { actions ->
                fun getContent(): Content {
                    ...
                    return Content(
                        ...
                        SettingsManager.isEncryptedDatabaseEnabled(),
                        SettingsManager.isDecoyVaultEnabled(),
                        SettingsManager.isQuickHideEnabled()
                    )
                }
